...
public class CarElectronicsRepair {
    ...
    public static void create_services(){
    ...
    public static void create_customers(){
    ...
    public static void create_technicians(){
    ...
    public static void create_maintenance(){
        System.out.printf("\n Tests for Class Maintenance\n\n");
        System.out.printf("\n Add_Maintenance()\n\n");
        add_maintenance(1, 1, 1, 2, "Pending");
        add_maintenance(2, 2, 4, 1, "Cancelled");
        add_maintenance(3, 1, 2, 4, "Conpletd");
        add_maintenance(4, 3, 5, 1, "Ongoing");
        add_maintenance(5, 4, 3, 5, "Pending");
    ...
    public static void add_maintenance(int maint_id, int cust_id, int service_id, int tech_id, String work_status) {
            Maintenance maint  =new Maintenance(maint_id, cust_id, service_id, tech_id, work_status);
    ...
    public static void list_one_maintenance(int maint_id) {
        ...
        while (itr.hasNext()) {
            ...
            if(maint_id==(maint.getMaint_id())){
                ...
                maint.getService_id(), maint.getTech_id(), maint.getWork_status());
            }
        }
        draw_line(130);
